...
@section('contenido')
    <div class="md:flex md:justify-center md:gap-10 md:items-center">
        ...
        <form method="POST" action="{{route('login')}}">
            ...
            <div class="mb-5">
                <input type="checkbox" name="remember"><label class="text-sm text-gray-500"> Mantener mi ssesión abierta </label>
            </div>
            <input type="submit" value="Iniciar Sesion" class="bg-sky-600 hover:bg-sky-700 transition-colors cursor-pointer uppercase text-white p-3 font-bold w-full rounded-lg">
        </form>
        </div>
    </div>
@endsection